...
public class StartPanel extends JPanel
{
	...
	/**
	 * RadioButton for the FamousNumber type.
	 */
	...
	/**
	 * String to populate the clueLabel if Famous Number is picked.
	 */
	private String numberClue;
	...
	public StartPanel(CelebrityGame controller)
	{
		...
		this.numberRadio = new JRadioButton("Famous Number");
		...
		this.numberClue = "Enter the clues for the famous number separated by commas";
	...
	private boolean validate(String answerText, String clueText)
	{
		...
		if (literatureRadio.isSelected()) {
			...
			validClue = controller.validateClue(clueText, "number");
		}
		else {
	...
	private void setupLayout()
	{
		...
		panelLayout.putConstraint(SpringLayout.NORTH, literatureRadio, 10, SpringLayout.SOUTH, numberRadio);
		panelLayout.putConstraint(SpringLayout.WEST, numberRadio, 0, SpringLayout.WEST, celebrityRadio);
		panelLayout.putConstraint(SpringLayout.NORTH, numberRadio, 10, SpringLayout.SOUTH, celebrityRadio);
	...
	private void setupListeners()
	{
		...
		numberRadio.addActionListener(select -> clueLabel.setText(numberClue));
